...
Este proyecto demostró la exitosa implementación de un sistema automatizado de clasificación y direccionamiento de materiales en una línea de empaquetamiento. Mediante la integración de un Arduino, sensores  y servomotores, se logró distinguir eficazmente entre objetos metálicos y plásticos, desviando cada tipo hacia conductos específicos.
